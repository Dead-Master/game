...
WEIGHTS_FILE="${1:-bot-service/config/weights.json}"
...
AI_P2_STRATEGY=ai_agent_v3_release \
AI_P1_NAME=ai_agent_v3 \
AI_P2_NAME=ai_agent_v3_release \
...
AI_BATTLES_COUNT="$BATTLES" \
AI_P1_STRATEGY=ai_agent_v3_release \
AI_P2_STRATEGY=ai_agent_v3 \
AI_P1_NAME=ai_agent_v3_release \
